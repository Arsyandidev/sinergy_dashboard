    ...
    <nav class="bottom-navbar">
        <div class="container">
            <ul class="nav page-navigation">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('gudang/permintaanBarang'); ?>" class="nav-link">
                    ...
                    <div class="submenu">
                        <ul>
                            <li class="nav-item"><a class="nav-link" href="<?= base_url('gudang/permintaanBarang'); ?>">Pengajuan<br>
                                    Permintaan Barang</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?= base_url('gudang/'); ?>">
                                    Inventaris</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?= base_url('gudang/kelolaInventaris'); ?>">Kelola
                                    Inventaris</a></li>
                        </ul>
                    </div>
                </li>
